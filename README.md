...
ContentFlow Agent 是一个面向内容创作者、独立开发者和小型运营团队的多 Agent 内容生产系统。项目目标是将选题研究、资料整理、内容大纲、文案初稿、内容审校、多平台改写和发布排期整合为一个自动化 AI 工作流。

## 项目背景

内容创作者和小型团队在日常运营中经常需要同时维护公众号、小红书、知乎、短视频平台和社交媒体账号。不同平台的内容风格、结构和表达方式差异较大，人工完成选题、写作、改写和审校需要大量时间。ContentFlow Agent 希望通过多 Agent 协作，将一次内容需求自动拆解为多个内容生产步骤，帮助用户更快生成高质量、多平台适配的内容包。

## 当前进度

项目目前处于本地 MVP 阶段，已经完成部分代码成果，包括：
...
当前版本支持输入主题、目标用户、目标平台和语气风格，并输出适配多个平台的内容草稿。
...
负责整理背景资料、目标用户痛点、竞品角度和常见问题。

### 3. Outline Agent

负责生成内容结构，包括标题、开头、主体段落、案例、总结和行动建议。
...
负责检查逻辑完整度、表达重复、风格匹配度和事实一致性。

### 6. Platform Rewrite Agent

负责将内容改写为适合公众号、小红书、知乎、短视频脚本和社交媒体短内容的不同版本。
